...
class TreatmentsControllerTest < ActionController::TestCase
  ...
  test "should create treatment" do
    assert_difference('Treatment.count') do
      post :create, treatment: { description: @treatment.description, member_id: @treatment.member_id, pastor: @treatment.pastor }
    end
  ...
  test "should update treatment" do
    patch :update, id: @treatment, treatment: { description: @treatment.description, member_id: @treatment.member_id, pastor: @treatment.pastor }
    assert_redirected_to treatment_path(assigns(:treatment))
  end
